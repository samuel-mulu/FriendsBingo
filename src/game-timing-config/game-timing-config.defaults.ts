...
export const DEFAULT_AUTO_CALL_INTERVAL_SECONDS = 18;
...
export const DEFAULT_WINNER_WINDOW_CLAIM_GRACE_MS = 2000;
...
export const DEFAULT_NO_WINNER_GRACE_SECONDS = 360;
